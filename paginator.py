...
class Commands:
    ...
    async def test(self, ctx):
        dict = {'Ping' : 'Pong', 'avatar <user>':"Brings up user's avatar. (If none, user=you.)",
                "choice": "picks between list of choices", "flip":"flips a coin"}
        paginator = FieldPages(ctx, entries=list(dict.items()), per_page=1)
